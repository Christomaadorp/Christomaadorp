                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.tasks.update", [$task->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="description" id="description" value="{{ old('description', $task->description) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('command') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="command" id="command" value="{{ old('command', $task->command) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('expression') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="expression" id="expression" value="{{ old('expression', $task->expression) }}">
                        ...
                        <div class="form-group {{ $errors->has('is_active') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="is_active" id="is_active" value="1" {{ $task->is_active || old('is_active', 0) === 1 ? 'checked' : '' }} data-toggle="toggle" data-offstyle="danger">
                                <label for="is_active" style="font-weight: 400">{{ trans('cruds.task.fields.is_active_ed_sh') }}</label>
                            </div>
                        ...
                        <div class="form-group {{ $errors->has('dont_overlap') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="dont_overlap" id="dont_overlap" value="1" {{ $task->dont_overlap || old('dont_overlap', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('run_in_maintenance') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="run_in_maintenance" id="run_in_maintenance" value="1" {{ $task->run_in_maintenance || old('run_in_maintance', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('notifications_email') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="notifications_email" id="notifications_email" value="{{ old('notifications_email', $task->notifications_email) }}">
                        ...
                        <div class="form-group {{ $errors->has('timestamps') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control timepicker" type="text" name="timestamps" id="timestamps" value="{{ old('timestamps', $task->timestamps) }}">
